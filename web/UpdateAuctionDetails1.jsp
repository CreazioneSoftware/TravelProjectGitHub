...
<html>
    ...
    int auc_details_id=Integer.parseInt(request.getParameter("auc_details_id"));
    ...
    int auc_details_no_of_adult=Integer.parseInt(request.getParameter("auc_details_no_of_adult"));
    ...
    int auc_id=Integer.parseInt(request.getParameter("auc_id"));
     ...
     auctiondetails.setAuc_details_id(auc_details_id);
     ...
     boolean b=auctiondetailsdao.isUpdateAuctionDetails(auctiondetails);
      
     if(b){
    
     System.out.println("Auction Details updated Successfully");
