...
public class Hotel_Category_Dao extends connectionInitializer{
  ...
  public boolean isAddHotelcat(com.pojo.Hotel_Category hc)throws Exception
  {
 ...
 int value=stmt.executeUpdate();
  ...
  public ArrayList<com.pojo.Hotel_Category> getAllHotelCategory()throws Exception{
     ...
     com.pojo.Hotel_Category hc;
      
      while(rs.next()){
         hc =new com.pojo.Hotel_Category();
